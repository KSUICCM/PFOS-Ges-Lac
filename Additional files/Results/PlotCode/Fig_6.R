#===========================================================================================================================
# Figure 6: Histogram of model simulations (right) compared with global measurements of PFOS in maternal plasma (round), cord blood (dimand) and breast milk (square) (left). 
# - Author : Wei-Chun Chou
# - Date   : March, 2020
# - Fig.6A : The PFOS time-crouse profiles in maternal palsma during gestation  
# - Fig.6B : The PFOS time-crouse profiles in maternal palsma during lactation
# - Fig.6C : The PFOS time-crouse profiles in pup palsma during lactation 
#===========================================================================================================================
