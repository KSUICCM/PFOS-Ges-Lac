#===========================================================================================================================
# Figure 4: Example of illustration of the general features/trends and model evaluation for PFOS levels in maternal plasma 
# - Author : Wei-Chun Chou
# - Date   : March, 2020
# - Fig.4A : The PFOS time-crouse profiles in maternal palsma during gestation  
# - Fig.4B : The PFOS time-crouse profiles in maternal palsma during lactation
# - Fig.4C : The PFOS time-crouse profiles in pup palsma during lactation 
#===========================================================================================================================
