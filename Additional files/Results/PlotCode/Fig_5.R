#===========================================================================================================================
# Figure 5: Example of illustration of the general features/trends 
# - Author : Wei-Chun Chou
# - Date   : March, 2020
# - Fig.5A : The PFOS time-crouse profiles in maternal palsma during gestation and lactation  
# - Fig.5B : The PFOS time-crouse profiles in human milk during lactation
#===========================================================================================================================
...
##================================================================================================
## Fig. 5A: Time-varying profiles of PFOS concentration in maternal and fetal palsma druing pregnancy
##
...
##================================================================================================
## Fig. 5a: Time-varying profiles of PFOS concentration in maternal and fetal/neolatal plasma druing lactation
##
p1 <- ggplot() + 
  geom_line (data = GL, aes(x = Time, y = CPlas_pup), colour = "red", lwd = 2, linetype = 1) + 
  geom_line (data = GL, aes(x = Time, y = CPlas), colour = "#00AFBB", lwd = 2) +
...
##================================================================================================
## Fig. 5b: Time-varying profiles of PFOS concentration in milk druing lactation
##
